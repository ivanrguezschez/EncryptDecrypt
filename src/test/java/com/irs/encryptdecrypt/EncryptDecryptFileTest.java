...
/**
 * Test unitario para la clase EncryptDecryptFile. El test consiste en encriptar
 * y desencriptar un archivo empleando una contraseña como clave de
 * encriptación.
 *
 * @author IRS
 * @version 1.0.0
 */
public class EncryptDecryptFileTest extends TestCase {
     ...
     */
    public EncryptDecryptFileTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(EncryptDecryptFileTest.class);
    }
